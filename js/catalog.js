        ...
        function performSearch() {
            ...
            if (searchTerm === '') {
                ...
                categories.forEach(category => {
                    ...
                    const categoryItems = category.querySelectorAll('.catalog-item');
            ...
            if (foundItems > 0) {
                searchResultsInfo.textContent = `Пошук: "${searchInput.value}" - знайдено ${foundItems} елементів у ${visibleCategories} категоріях`;
            } else {
                searchResultsInfo.textContent = `Пошук: "${searchInput.value}" - нічого не знайдено`;
            }
        }
